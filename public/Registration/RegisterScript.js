document.addEventListener("DOMContentLoaded", function () {
    ...
    // Validate and calculate age on blur
    dobInput.addEventListener("change", function () {     
      if (this.value) {
        ...
        const minValidDate = new Date(today.getFullYear() - maxAge, today.getMonth(), today.getDate());
        ...
        if (selectedDate < minValidDate || selectedDate > maxValidDate) {
          alert(`Date of birth must indicate an age between ${minAge} and ${maxAge} years.`);
          ageInput.value = ""; // Clear age if invalid
        } else {
